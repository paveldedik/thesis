...
\begin{equation} \label{online-learning-batch-rule}
 p_j \gets p_j - \alpha~\frac{1}{n}\sum_{i=0}^n (P_n - y_n)~~\text{for all } j
\end{equation}
...
\begin{figure}[htbp]
  ...
  \caption{Result of the grid search performed on the PFAE model with 2 parameters. The figure on the right hand size shows the averages of $P_n - y_n$ over all answers for a grid of parameters.}
