...
\begin{figure}[htbp]
  ...
  \caption{A fabricated example of the spacing effect with two students. The first student $s_1$ attended 3 sessions (at times $t_0$, $t_1$ and $t_2$) and practiced 50 cues on each, the second student $s_2$ attended only 1 session at the time $t_0$ where they practiced all 150 cues.}
